...
_SETTINGS_DEFAULTS = {
    ...
    "notifications_complete_enabled": False,  # 'Response complete' pushes (opt-in; spam with many parallel sessions) — approvals/clarifications follow notifications_enabled
...
_SETTINGS_BOOL_KEYS = {
    ...
    "notifications_complete_enabled",
    "show_thinking",
